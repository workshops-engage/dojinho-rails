...
ActiveRecord::Schema.define(:version => 20120227170822) do
  ...
  add_index "favorites", ["user_id", "rank"], :name => "index_favorites_on_user_id_and_rank", :unique => true
  ...
  add_foreign_key "favorites", "movies", :name => "favorites_movie_id_fk"
